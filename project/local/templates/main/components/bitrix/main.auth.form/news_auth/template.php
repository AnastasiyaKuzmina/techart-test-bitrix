...
\Bitrix\Main\Page\Asset::getInstance()->addCss(
	SITE_TEMPLATE_PATH . "/assets/css/auth/style.css"
);

if ($arResult['AUTHORIZED'])
{
	echo '<h1>' . Loc::getMessage('MAIN_AUTH_FORM_SUCCESS') . '</h1>';
	return;
}
?>
...
<div class="bx-authform">
	...
	<form name="<?= $arResult['FORM_ID'];?>" method="post" target="_top" action="<?= POST_FORM_ACTION_URI;?>">
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="btn btn-primary btn_style" name="<?= $arResult['FIELDS']['action'];?>" value="<?= Loc::getMessage('MAIN_AUTH_FORM_FIELD_SUBMIT');?>" />
		</div>
