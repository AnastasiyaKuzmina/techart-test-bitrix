...
\Bitrix\Main\Page\Asset::getInstance()->addCss(
	SITE_TEMPLATE_PATH . "/assets/css/auth/register.css"
);
?>
...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	<?else:?>
		<tr class="register-field">
			<td class="register-field__label"><?=GetMessage("REGISTER_FIELD_".$FIELD)?>:<?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span class="starrequired">*</span><?endif?></td>
			<td class="register-field__input"><?
	switch ($FIELD)
	{
		case "PASSWORD":
...
?>
	...
	<tfoot>
		<tr>
			<td></td>
			<td class="register-field__input"><input type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
		</tr>
	</tfoot>
</table>
</form>

<p class="register-hint"><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p>

<?endif //$arResult["SHOW_SMS_FIELD"] == true ?>

<p class="register-hint"><span class="starrequired">*</span><?=GetMessage("AUTH_REQ")?></p>
